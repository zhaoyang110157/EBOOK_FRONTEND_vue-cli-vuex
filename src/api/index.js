...
// 1、登录
export const reqLogin = ({account, password}) => ajax(BASE_URL+'/Users/signIn', {account, password}, 'POST')

// 2、注册
export const reqSignup = ({account, allowed, password, role, id}) => ajax(BASE_URL+'/Users/signUp', {account,  allowed, password, role, id}, 'POST')
...
// 5、获取所有书籍
export const reqGetAllBook = () => ajax(BASE_URL+'/Book/getAll')
